const ABOUT_DATA = {
  en: [
    ...
    },
    {
      ...
      content: 'My core is async PHP (Swoole) with PostgreSQL and Redis, paired with Vue/Nuxt on the frontend. I\'ve built content storage, transactional billing, and real-time engines from scratch — and I pick tools by the problem, not by habit.'
    },
    {
      title: 'Work Model',
      content: 'I take full ownership of my domain. I\'ve shipped an entire platform solo as the sole engineer, and I plug into an existing team just as fast — delivering without micromanagement.'
    }
  ],
  ru: [
    {
      title: 'Архитектурный подход',
      content: 'Строю системы целиком, а не отдельные фичи. Опираюсь на чёткие доменные границы (DDD), отказоустойчивость и код, который остаётся поддерживаемым по мере роста продукта — чтобы архитектура помогала бизнесу, а не мешала ему.'
    },
    {
      title: 'Техническая экспертиза',
      content: 'Ядро — асинхронный PHP (Swoole) с PostgreSQL и Redis, на фронте Vue/Nuxt. С нуля строил контент-хранилище, транзакционный биллинг и реалтайм-движки — и подбираю инструменты под задачу, а не по привычке.'
    },
    {
      title: 'Формат работы',
      content: 'Беру полную ответственность за свой домен. Запускал целую платформу соло как единственный инженер и так же быстро вливаюсь в готовую команду — выдаю результат без микроменеджмента.'
    }
  ],
  hy: [
    {
